...
The final input data can be found [here](https://raw.githubusercontent.com/NGWPC/mip-riverml/refs/heads/main/data/riverML_ripple_beta_units.parquet)

The final predicted data can be found [here](https://raw.githubusercontent.com/NGWPC/mip-riverml/refs/heads/main/data/riverML_ripple_beta_predictions.parquet)

The final deployable model can be found [here (with permisions)](https://github.com/NGWPC/predict-riverML)
